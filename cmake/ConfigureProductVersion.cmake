...
# This target will update the git (and other info from CLIs) information in the header git-config-bsql-select.h, see config-bsql-select.h.cmake
...
# Each time we build the target we update the config-bsql-select.h file and thus always have the last git commit hash (without run cmake again)
# TODO percy arrow romulo mario enable this when we want to deploy the blazing arrow flavor in conda
#add_dependencies(blazingsql-select UpdateBSQLEngineInternalConfig)
